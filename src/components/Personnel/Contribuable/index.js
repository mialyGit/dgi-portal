...
const Utilisateur = () => {
    ...
    const columns = [
        ...
        {
            name: 'NIF',
            selector : row => row.contribuable.nif
        },
        {
            name: 'Utilisateur',
            cell: row => 
        ...
        {
            name: 'Options',
            cell: row => <><button className="theme-bg-btn red" onClick={() => remove(row.contribuable.id)}>Supprimer</button><button className="theme-bg-btn blue" onClick={() => voir_details(row)} >Détails</button></>
        },
    ];
            ...
            <Row>
                <Col>
                    <Card className='Recent-Users'>
                        <Card.Header>
                            <Card.Title as='h5'>Liste des contribuables</Card.Title>
                            <div className="card-header-right">
                                <Row>
                                    <Col className="mt-1">
                                        <Link to="/contribuables/new">
                                            <Button variant="secondary" size="sm">Ajouter un contribuable</Button>
                                        </Link>
                                    </Col>
                                    <Col  className="mt-1">
                                        <InputGroup size="sm">
